...
.opi files. It uses converter.jar, built from the latest version
of the OPIBuilder converter.

    java -jar converter.jar <filename> <destination>
    ...
    def _convert_one_file(self, full_path, outdir, force, depth):
        ...
        try:
            if not force and self._already_converted(outdir, full_path):
                ...
                if files.convert_edl(full_path, destination):
